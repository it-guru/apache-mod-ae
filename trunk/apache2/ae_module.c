...
module AP_MODULE_DECLARE_DATA ae_auth_module;
...
static void ae_parse_seperator(request_rec *r,char *user)
{
   ...
   aeauth_config_rec *sec=ap_get_module_config(r->per_dir_config, &ae_auth_module);
   int  c,s;
...
static int ae_find_chkfile(request_rec *r,char **chkfilename)
{
   ...
   (aeauth_config_rec *) ap_get_module_config(r->per_dir_config, &ae_auth_module);
