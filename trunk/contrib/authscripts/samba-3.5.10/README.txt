The directory structure of samba 3.5.10 is a little bit confused. Soo i have
...
Step 2: apply patch
=======
  patch -p0 < ~/samba-3.5.10-smb3passchk-01.diff
...
After these steps, you should find the executable at ...
  ...
  ./samba-3.5.10/source3/smb3passchk/smb3passchk
